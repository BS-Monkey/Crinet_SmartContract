        ...
        <div>
           <Container>
              ...
              <h5 className='text-secondary'>Your Referral Link: <br />
                <code>{blockchain.account ? window.location.origin + '?r=' + blockchain.account : '(Please connect wallet to get your referral link)'}</code>
              </h5>

              <div><a href='/pdfs/referral.pdf' target="_blank" rel="noreferrer noopener">
              <button className='affiliate-btn'><h6 style={{margin: '0'}}>AFFILIATE PROGRAM GUIDE</h6></button></a>
              </div>
